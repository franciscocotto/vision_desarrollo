 ...
 * @author Angel
 */
@WebServlet(name = "deleteCapital", urlPatterns = {"/deleteCapital"})
public class deleteCapital extends HttpServlet {
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response)
        ...
        //eso de hace la consulta
           ...
           //creando constructor
            ...
            modelo.addCapital borrarServicio = new modelo.addCapital();
        try {
            borrarServicio.elimina(servicio);//envia objeto a addClientes.
        } catch (SQLException ex) {//captura error de existir
            Logger.getLogger(deleteCapital.class.getName()).log(Level.SEVERE, null, ex);
        }
            response.sendRedirect("capital");//se redirecciona al index una vez terminado el eliminado de registros
    }
