 ...
 * @author Angel
 */
@WebServlet(name = "deleteCompra", urlPatterns = {"/deleteCompra"})
public class deleteCompra extends HttpServlet {
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            Logger.getLogger(deleteCompra.class.getName()).log(Level.SEVERE, null, ex);
        }
            response.sendRedirect("compras");//se redirecciona al index una vez terminado el eliminado de registros
    }
