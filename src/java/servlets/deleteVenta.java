    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response)
        ...
        //eso de hace la consulta
           ...
           //creando constructor
             ...
             venta.setCodigo(Integer.parseInt(Id));//se cambia el tipo de variable por int desde string
             //objeto para borrar cliente
            modelo.addVenta borrarVenta = new modelo.addVenta();
        try {
            borrarVenta.elimina(venta);//envia objeto a addClientes.
