 ...
 * @author Angel Cotto
 */
@WebServlet(name = "formEditaCapital", urlPatterns = {"/formEditaCapital"})
public class formEditaCapital extends HttpServlet {
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response)
        ...
        //capturando valores del form
         ...
         //almacenando datos en las variables con el constructor 
            ...
            modelo.addCapital editaservicio = new modelo.addCapital();
            editaservicio.edita(servicio);
            response.sendRedirect("capital");//si se guarda exitosamente se redirecciona a membresia
    }
