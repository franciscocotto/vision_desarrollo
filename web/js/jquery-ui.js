...
//                , alt: buttonText, title: buttonText
        ...
        _dialogDatepicker: function(input, date, onSelect, settings, pos) {
            ...
            if (!inst) {
                ...
                this._dialogInput = $("<input type='text' id='" + id +
                        "' style=' position: absolute; top: -50px; width: 0px;'/>");
        ...
        _showDatepicker: function(input) {
            ...
            offset = {left: $.datepicker._pos[0] + 105, top: $.datepicker._pos[1] - 5};
...
//                       top: "592px"
        ...
        _checkOffset: function(inst, offset, isFixed) {
            ...
            offset.right -= (isFixed && offset.right === inst.input.offset().left) ? $(document).scrollLeft() : 0;
