    ...
    <section role="main" class="content-body">
       ...
       <div class="container-fluid">
          ...
          Connection  cn2 = con.conectar();//se conecto a la base de datos
           String sql3="Select count(id_ventas), Sum(cantidad), SUM(precio),  SUM(total_pago) as sumprice from ventas";
           int sum = 0;
           Statement st2;               
                try {
                            ...
                            <div class="panel-heading h145">
                                <div class="row vertical">
                                    ...
                                    <div class="col-xs-8 bleft">
                                        ...
                                        <div>Total de Ventas Realizadas</div>
                                    </div>
                                </div>
                            </div>
                                                  </div>
                            ...
                            <div class="panel-heading h145">
                                <div class="row vertical">
                                    ...
                                    <div class="col-xs-8 bleft">
                                        ...
                                        <div>Total de Items Vendidos</div>
                                    </div>
                                </div>
                            </div>
                                                  </div>
