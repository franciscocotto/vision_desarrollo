							...
							<section class="card">
								...
								<div class="card-body">
                                                                    ...
                                                                    <div class="col-lg-2 nopadding mr-2">
                                                                       <button type="button" id="save-notify" name="regresar" class="col-lg-12 t5 btn-left btn btn-default" data-target="#agregarempleado" data-toggle="modal">
									...
									<hr>
                                                                        <div class="col-md-12"  style="float: none">
                                                                            	 <jsp:include page="tableEmpleados.jsp" />   
                                                                        </div>
...
<!-- Modals -->
 <jsp:include page="deleteEmpleados.jsp" />
 <jsp:include page="addEmpleado.jsp" />
 <jsp:include page="readEmpleados.jsp" />
    </body>
