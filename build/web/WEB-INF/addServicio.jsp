...
<div class="modal fade resette" id="agregarservicio" tabindex="-1" role="dialog" aria-labelledby="myModalLabel">
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            <div class="modal-header">
                <button type="button" class="close" data-dismiss="modal" aria-label="Close"><span aria-hidden="true">&times;</span></button>
                <h4 class="page-alerth" style="margin-top:0;">
                    <i class="fa pg2 fa-fw fa-bell"></i> Agregar Nuevos Pagos de Servicios
                </h4>
            </div>
            <form id="agregaruser" action="formServicios" method="post" class="resetform form-horizontal">
                <div class="modal-body" style="min-height:  150px !important">
                    <div class="form-group letra">
                        ...
                        <div class="col-md-8">
                            <input class="form-control" type="text" name="descripcion" placeholder="Ingresar la descripción del servicio" required="required" maxlength="60" minlength="3"/>    
                        </div>
                    </div> 
