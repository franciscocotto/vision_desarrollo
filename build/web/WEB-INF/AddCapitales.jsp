			...
			<aside id="sidebar-left" class="sidebar-left">
				...
				<section role="main" class="content-body">
					<header class="page-header">
                                            <h2>Administraci&oacute;n de Capital</h2>
					</header>		
					<div class="row pt-4">
						<div class="col">
							...
							<section class="card">
								...
								<div class="card-body">
                                                                    ...
                                                                    <div class="col-lg-2 nopadding mr-2">
                                                                      <button type="button" id="save-notify" name="regresar" class="col-lg-12 t5 btn-left btn btn-default" data-target="#agregarcapital" data-toggle="modal">
									...
									<hr>
                                                                        <div class="col-md-12"  style="float: none">
                                                                            	 <jsp:include page="tableCapital.jsp" />   
                                                                        </div>
...
<!-- Modals -->
 <jsp:include page="deleteCapital.jsp" />
 <jsp:include page="addCapital.jsp" />
 <jsp:include page="readCapital.jsp" />
    </body>
