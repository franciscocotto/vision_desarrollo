...
<!-- Modal Desvincular -->
<div class="modal fade resette" id="readcapital" tabindex="-1" role="dialog" aria-labelledby="myModalLabel">
    <div class="modal-dialog" role="document">
        <div class="modal-content">
                 <form id="agregaruser" action="formEditaCapital" method="post" class="resetform form-horizontal">
                        <div class="modal-header">
                <div class="col-md-6">
                <h4 class="page-alerth" style="margin-top:0;">
                    <i class="fa pg2 fa-fw fa-bank"></i> Editar Capital de Inversi&oacute;n
                </h4>
                </div>
                <div class="col-md-5">
                  <div class="form-group">
                        <label class="col-md-6 control-label">ID Capital</label>
                        <div class="col-md-6">
                ...
                <div class="modal-body">
                    <div class="form-group letra">
                        ...
                        <div class="col-md-8">
                            <input class="form-control adddescripcion" type="text" name="descripcion" placeholder="Ingresar la descripción del capital" required="required" maxlength="60" minlength="3"/>    
                        </div>
                    </div> 
